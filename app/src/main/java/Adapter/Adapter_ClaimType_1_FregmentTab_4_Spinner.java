...
public class Adapter_ClaimType_1_FregmentTab_4_Spinner extends BaseAdapter {
    ...
    public Adapter_ClaimType_1_FregmentTab_4_Spinner(Context context, ArrayList<String> data) {
