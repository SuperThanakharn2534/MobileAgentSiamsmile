...
public class Adapter_ClaimTypeMenu_2_FragmentTab_1 extends BaseAdapter {
    ...
    public Adapter_ClaimTypeMenu_2_FragmentTab_1(Context context, ArrayList<Integer> imageId, ArrayList<String> AppId,
