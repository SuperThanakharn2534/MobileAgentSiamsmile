...
public class Adapter_Notification_1_FregmentTab_1_Spinner extends BaseAdapter {
    ...
    public Adapter_Notification_1_FregmentTab_1_Spinner(Context context, ArrayList<String> data) {
