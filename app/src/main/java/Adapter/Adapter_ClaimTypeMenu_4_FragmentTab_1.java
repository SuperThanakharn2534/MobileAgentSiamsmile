...
public class Adapter_ClaimTypeMenu_4_FragmentTab_1 extends BaseAdapter {
   ...
   // ArrayList<String> statusAler = new ArrayList<>();
    ...
    public Adapter_ClaimTypeMenu_4_FragmentTab_1(Context context, ArrayList<Integer> imageId, ArrayList<String> AppId,
