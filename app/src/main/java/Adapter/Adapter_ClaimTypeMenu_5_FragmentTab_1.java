...
public class Adapter_ClaimTypeMenu_5_FragmentTab_1 extends BaseAdapter {
   ...
   // ArrayList<String> statusAler = new ArrayList<>();
    ...
    public Adapter_ClaimTypeMenu_5_FragmentTab_1(Context context, ArrayList<Integer> imageId, ArrayList<String> AppId,
                                                 ArrayList<String> data1, ArrayList<String> data2, ArrayList<String> data3
            , ArrayList<String> data4, ArrayList<String> data5, ArrayList<String> data6, ArrayList<String> data7
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(view == null)
            view = mInflater.inflate(R.layout.claimtypemenu_3_fragmenttab_model, parent, false);
