...
public class Adapter_PaySearch_2_FragmentTab_2_Tab_3 extends BaseAdapter {
    ...
    public Adapter_PaySearch_2_FragmentTab_2_Tab_3(Context context, ArrayList<Integer> imageId,ArrayList<String> AppId,
