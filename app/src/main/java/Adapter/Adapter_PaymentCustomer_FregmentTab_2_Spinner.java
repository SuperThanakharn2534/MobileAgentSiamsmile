...
public class Adapter_PaymentCustomer_FregmentTab_2_Spinner extends BaseAdapter {
    ...
    public Adapter_PaymentCustomer_FregmentTab_2_Spinner(Context context, ArrayList<String> data) {
