...
public class Adapter_PaymentReport_FregmentTab_2_Spinner extends BaseAdapter {
    ...
    public Adapter_PaymentReport_FregmentTab_2_Spinner(Context context, ArrayList<String> data) {
