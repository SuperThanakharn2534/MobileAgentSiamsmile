...
public class Adapter_PaymentCustomer_FregmentTab_6_Spinner extends BaseAdapter {
    ...
    public Adapter_PaymentCustomer_FregmentTab_6_Spinner(Context context, ArrayList<String> data) {
