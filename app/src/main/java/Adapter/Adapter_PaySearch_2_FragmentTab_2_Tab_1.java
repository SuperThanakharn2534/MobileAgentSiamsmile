...
public class Adapter_PaySearch_2_FragmentTab_2_Tab_1 extends BaseAdapter {
    ...
    public Adapter_PaySearch_2_FragmentTab_2_Tab_1(Context context, ArrayList<Integer> imageId,ArrayList<String> AppId,
