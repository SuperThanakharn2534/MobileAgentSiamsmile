...
public class Adapter_PaymentCustomer_FregmentTab_3_Spinner extends BaseAdapter {
    ...
    public Adapter_PaymentCustomer_FregmentTab_3_Spinner(Context context, ArrayList<String> data) {
