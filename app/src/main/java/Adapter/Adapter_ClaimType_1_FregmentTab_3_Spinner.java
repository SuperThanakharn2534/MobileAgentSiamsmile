...
public class Adapter_ClaimType_1_FregmentTab_3_Spinner extends BaseAdapter {
    ...
    public Adapter_ClaimType_1_FregmentTab_3_Spinner(Context context, ArrayList<String> data) {
