...
public class Adapter_ClaimType_1_FregmentTab_1_Spinner extends BaseAdapter {
    ...
    public Adapter_ClaimType_1_FregmentTab_1_Spinner(Context context, ArrayList<String> data) {
