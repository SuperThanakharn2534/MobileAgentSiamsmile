...
public class Adapter_Notification_1_FregmentTab_3_Spinner extends BaseAdapter {
    ...
    public Adapter_Notification_1_FregmentTab_3_Spinner(Context context, ArrayList<String> data) {
