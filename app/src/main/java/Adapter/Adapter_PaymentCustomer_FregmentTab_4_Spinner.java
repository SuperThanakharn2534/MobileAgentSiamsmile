...
public class Adapter_PaymentCustomer_FregmentTab_4_Spinner extends BaseAdapter {
    ...
    public Adapter_PaymentCustomer_FregmentTab_4_Spinner(Context context, ArrayList<String> data) {
