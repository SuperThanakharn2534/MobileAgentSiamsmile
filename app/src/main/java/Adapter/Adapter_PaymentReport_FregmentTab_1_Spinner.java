...
public class Adapter_PaymentReport_FregmentTab_1_Spinner extends BaseAdapter {
    ...
    public Adapter_PaymentReport_FregmentTab_1_Spinner(Context context, ArrayList<String> data) {
