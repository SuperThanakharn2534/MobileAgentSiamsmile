...
public class Adapter_ClaimType_1_FregmentTab_2_Spinner extends BaseAdapter {
    ...
    public Adapter_ClaimType_1_FregmentTab_2_Spinner(Context context, ArrayList<String> data) {
