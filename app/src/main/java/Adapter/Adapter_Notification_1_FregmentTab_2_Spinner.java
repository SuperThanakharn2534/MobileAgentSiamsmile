...
public class Adapter_Notification_1_FregmentTab_2_Spinner extends BaseAdapter {
    ...
    public Adapter_Notification_1_FregmentTab_2_Spinner(Context context, ArrayList<String> data) {
