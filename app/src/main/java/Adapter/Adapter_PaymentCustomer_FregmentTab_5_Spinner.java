...
public class Adapter_PaymentCustomer_FregmentTab_5_Spinner extends BaseAdapter {
    ...
    public Adapter_PaymentCustomer_FregmentTab_5_Spinner(Context context, ArrayList<String> data) {
