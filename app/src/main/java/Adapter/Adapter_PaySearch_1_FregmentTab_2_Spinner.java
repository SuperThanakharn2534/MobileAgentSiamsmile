...
public class Adapter_PaySearch_1_FregmentTab_2_Spinner  extends BaseAdapter {
    ...
    public Adapter_PaySearch_1_FregmentTab_2_Spinner(Context context, ArrayList<String> data) {
