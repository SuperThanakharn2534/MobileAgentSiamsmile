...
public class Adapter_ClaimType_1_FregmentTab_6_Spinner extends BaseAdapter {
    ...
    public Adapter_ClaimType_1_FregmentTab_6_Spinner(Context context, ArrayList<String> data) {
