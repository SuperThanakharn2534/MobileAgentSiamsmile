...
public class Adapter_PaymentCustomer_FregmentTab_8_Spinner extends BaseAdapter {
    ...
    public Adapter_PaymentCustomer_FregmentTab_8_Spinner(Context context, ArrayList<String> data) {
