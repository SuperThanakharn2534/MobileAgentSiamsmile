...
public class Adapter_PaySearch_1_FragmentTab_1 extends BaseAdapter {
   ...
   // ArrayList<String> statusAler = new ArrayList<>();
    ...
    public Adapter_PaySearch_1_FragmentTab_1(Context context, ArrayList<Integer> imageId, ArrayList<String> AppId,
                                             ArrayList<String> Name,ArrayList<String> Name2,ArrayList<String> type
            ,ArrayList<String> Detail,ArrayList<String> amount,ArrayList<Integer> imageId2) {
