...
public class Adapter_ClaimType_1_FregmentTab_5_Spinner extends BaseAdapter {
    ...
    public Adapter_ClaimType_1_FregmentTab_5_Spinner(Context context, ArrayList<String> data) {
