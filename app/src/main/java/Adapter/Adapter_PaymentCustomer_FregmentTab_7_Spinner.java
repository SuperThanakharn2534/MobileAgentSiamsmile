...
public class Adapter_PaymentCustomer_FregmentTab_7_Spinner extends BaseAdapter {
    ...
    public Adapter_PaymentCustomer_FregmentTab_7_Spinner(Context context, ArrayList<String> data) {
