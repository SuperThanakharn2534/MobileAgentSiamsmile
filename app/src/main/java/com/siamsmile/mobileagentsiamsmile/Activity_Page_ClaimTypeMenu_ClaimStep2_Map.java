...
public class Activity_Page_ClaimTypeMenu_ClaimStep2_Map extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_claimtypemenu_claimstep2_map);
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimTypeMenu_ClaimStep2_Map.this));
...
//        });
        ...
        Button back_ = (Button)findViewById(R.id.bt_step3_back);
