...
public class Activity_Page_PayCustomer_Detail extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_paycutomer_detail);

        try {
            SetHeader("บันทึกการชำระเบี้ยประกัน_02", false, false);
            SetMenu();
            Button();
            SetBottom();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_PayCustomer_Detail.this));
    ...
    public  void Button(){
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_PayCustomer_History.class));
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_PayCustomer_Payment.class));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_PayCustomer_Detail.this));
    ...
    public void  SetBottom_NewAppPayment(){
        ...
        gridview2.setAdapter(new Adapter_Payment(this,Activity_Page_PayCustomer_Detail.this));
