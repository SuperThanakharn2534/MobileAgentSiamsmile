...
public class PaySearch_2_FragmentTab_2_TabFragment_1 extends Fragment  {
    ...
    public PaySearch_2_FragmentTab_2_TabFragment_1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate( R.layout.paysearch_2_fragmenttab_2_tabfragment_1, container, false );
...
//                startActivity(new Intent(getActivity(),PaySearch_2_FragmentTab_2_TabFragment_1_PopUp.class));
//            }
//        } );
        button.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.paysearch_2_fragmenttab_2_tabfragment_1_popup);
