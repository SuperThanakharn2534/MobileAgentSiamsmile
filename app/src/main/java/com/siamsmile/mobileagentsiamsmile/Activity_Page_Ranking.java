...
public class Activity_Page_Ranking extends AppCompatActivity  implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            SetHeader("ข้อมูลการแข่งขัน", false, false);
            SetMenu();
            SetBottom();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_Ranking.this));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_Ranking.this));
