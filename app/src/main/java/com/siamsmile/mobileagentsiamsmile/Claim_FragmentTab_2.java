...
import Adapter.Adapter_ClaimTypeMenu_2_FragmentTab_1;
import Adapter.Adapter_ClaimType_1_FregmentTab_2_Spinner;

/**
 * Created by aligndev on 02-Nov-17.
 */

public class Claim_FragmentTab_2 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate( R.layout.claim_fragmenttab_2, container, false );
        ...
        Adapter_ClaimTypeMenu_2_FragmentTab_1 adapter = new Adapter_ClaimTypeMenu_2_FragmentTab_1(getActivity(),imageId
        ...
        Datalist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                startActivity(new Intent(getActivity(), Claim_FragmentTab_3_Detail.class));
            }
        });
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView( R.layout.claim_fragmenttab_2_detail_popup );
                ...
                Adapter_ClaimType_1_FregmentTab_2_Spinner spiner = new  Adapter_ClaimType_1_FregmentTab_2_Spinner(getActivity(),list_01);
                s.setAdapter(spiner);

                Spinner s2 = (Spinner) dialog.findViewById(R.id.Spinner_List_02);
                Adapter_ClaimType_1_FregmentTab_2_Spinner spiner2 = new  Adapter_ClaimType_1_FregmentTab_2_Spinner(getActivity(),list_02);
