...
import Adapter.Adapter_TabBar_Payment;
...
public class Tab extends AppCompatActivity implements AdapterView.OnItemClickListener  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            SetHeader("รายงานลูกค้า", false, false);
            SetMenu();
            SetBottom();
            SetTab();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Tab.this));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Tab.this));
    ...
    public void SetTab(){
         ...
         TabBar =new Adapter_TabBar_Payment( getSupportFragmentManager() );
        ...
        TextView tabfont7 = (TextView) LayoutInflater.from(this).inflate(R.layout.claim_tabsbar_layout,null);
        TextView tabfont8 = (TextView) LayoutInflater.from(this).inflate(R.layout.claim_tabsbar_layout,null);

        tabfont1.setText("Prospect");
        tabfont2.setText("APP แห้ง");
        tabfont3.setText("NEW APP สมบูรณ์ ");
        tabfont4.setText("คัดกรองผ่าน");
        tabfont5.setText("ไม่ผ่านคัดกรอง");
        tabfont6.setText("ยกเลิก");
        tabfont7.setText("ทั้งหมด");
        tabfont8.setText("ใกล้หมดอายุ");
        ...
        tabLayout.getTabAt(6).setCustomView(tabfont7);
        tabLayout.getTabAt(7).setCustomView(tabfont8);
