...
public class Activity_Page_ClaimTypeMenu_ClaimStep6_ClaimSign extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_claimtypemenu_claimstep6_claimsign );
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this, Activity_Page_ClaimTypeMenu_ClaimStep6_ClaimSign.this));
