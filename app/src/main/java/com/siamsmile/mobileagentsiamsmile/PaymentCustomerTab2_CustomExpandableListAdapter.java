...
public class PaymentCustomerTab2_CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public PaymentCustomerTab2_CustomExpandableListAdapter(Context context, List<String> appid, List<String> Name , List<String> Product,List<String> expire_date,
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate( R.layout.paymentcustomer2_tab_list_item, null );
        }
    ...
    public View getGroupView(final int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService( Context.LAYOUT_INFLATER_SERVICE );
            convertView = layoutInflater.inflate( R.layout.paymentcustomer2_tab_list_group, null );
        }
        //code set Text Data
