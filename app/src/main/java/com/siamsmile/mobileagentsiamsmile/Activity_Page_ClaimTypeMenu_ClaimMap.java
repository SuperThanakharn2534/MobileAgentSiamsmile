...
public class Activity_Page_ClaimTypeMenu_ClaimMap extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_claimtypemenu_claimmap);
        try {
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimTypeMenu_ClaimMap.this));
    ...
    public  void Button_claimpayment(){
        ...
        next_test.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_ClaimTypeMenu_ClaimFeedBack.class));
            }
        });


        Button back_test = (Button)findViewById(R.id.bt_claimmap_05_back);
