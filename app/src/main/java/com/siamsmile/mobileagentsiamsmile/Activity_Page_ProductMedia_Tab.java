...
import Adapter.Adapter_ProductMedia_Tab;
...
public class Activity_Page_ProductMedia_Tab extends AppCompatActivity implements AdapterView.OnItemClickListener  {
    ...
    //TabBar
    private Adapter_ProductMedia_Tab TabBar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_productmedia_tab );
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ProductMedia_Tab.this));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_ProductMedia_Tab.this));
    ...
    public void SetTab(){
         ...
         TabBar =new Adapter_ProductMedia_Tab( getSupportFragmentManager() );
        ...
        tabfont1.setText("สือและผลิตภัณฑ์");
        tabfont2.setText("คู่มือการขาย");
