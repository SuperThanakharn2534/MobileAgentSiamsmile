...
public class Activity_Page_LogInPinCode extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_login_pincode );
...
//                setIsPass();
                Intent intent = new Intent(this, Activity_Page_Main.class);
