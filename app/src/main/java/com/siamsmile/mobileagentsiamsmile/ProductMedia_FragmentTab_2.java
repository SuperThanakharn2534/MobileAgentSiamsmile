...
public class ProductMedia_FragmentTab_2 extends android.support.v4.app.Fragment {
    ...
    public ProductMedia_FragmentTab_2() {
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // return init(inflater.inflate(R.layout.producttmedia_fragmenttab_2, container, false));

        View rootView = inflater.inflate( R.layout.producttmedia_fragmenttab_2, container, false );
        return rootView;
