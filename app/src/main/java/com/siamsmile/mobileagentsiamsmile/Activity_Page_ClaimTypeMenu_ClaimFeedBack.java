...
public class Activity_Page_ClaimTypeMenu_ClaimFeedBack extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_claimtypemenu_claimfeedback);
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimTypeMenu_ClaimFeedBack.this));
