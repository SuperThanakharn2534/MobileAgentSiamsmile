...
public class Activity_Page_NewAppPayment_03 extends AppCompatActivity  implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_newapppayment_03 );


        try {
            SetHeader("บันทึก NewAppPayment_03", false, false);
            SetBottom();
            SetMenu();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this, Activity_Page_NewAppPayment_03.this));
    ...
    public void  SetBottom(){
      ...
      Button buttom = (Button)findViewById( R.id.bt_backpagenewapplist );
        buttom.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_NewAppDetail_01.class));
            }
        } );
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_NewAppPayment_03.this));
    ...
    public void  SetBottom_NewAppPayment(){
        ...
        gridview2.setAdapter(new Adapter_Payment(this,Activity_Page_NewAppPayment_03.this));
