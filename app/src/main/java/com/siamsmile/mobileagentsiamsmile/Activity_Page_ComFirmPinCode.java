...
public class Activity_Page_ComFirmPinCode extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_comfirmpincode );
...
//                setIsPass();
                Intent intent = new Intent(this, Activity_Page_Login.class);
