...
public class Activity_Page_ClaimTypemenu_ClaimPayment extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_claimtypemenu_claimpayment);
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimTypemenu_ClaimPayment.this));
    ...
    public  void Test1(){
        ...
        Button next_test = (Button)findViewById(R.id.bt_next_page_claimmap);
        next_test.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_ClaimTypeMenu_ClaimMap.class));
            }
        });


        Button back_test = (Button)findViewById(R.id.bt_claimpayment05_back);
