...
public class Activity_Page_PayCustomer_History extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_paycustomer_history);
        try {
            SetHeader("บันทึกการชำระเบี้ยประกัน_03", false, false);
            SetMenu();
            Button();
            SetBottom();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_PayCustomer_History.this));
    ...
    public  void Button(){
        ...
        Button sent = (Button)findViewById(R.id.bt_nextpage_payment);
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_PayCustomer_History.this));
