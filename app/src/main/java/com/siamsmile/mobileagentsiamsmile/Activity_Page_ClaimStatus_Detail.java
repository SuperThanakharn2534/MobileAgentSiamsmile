...
public class Activity_Page_ClaimStatus_Detail extends AppCompatActivity  implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_claimstatus_detail );

        try {
            SetHeader("รายละเอียดสถานะการเคลม", false, false);
            SetMenu();
           // Button();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimStatus_Detail.this));
    ...
    public  void Button(){
        ...
        Button sent =(Button)findViewById( R.id.BT_NextPage );
        sent.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_ClaimStatus_Detail.class));
            }
        } );
