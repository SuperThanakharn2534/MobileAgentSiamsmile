...
import Adapter.Adapter_TabBar_Activity_Page_Notification_Tab;
...
public class Activity_Page_Notification_Tab extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    //TabBar
    private Adapter_TabBar_Activity_Page_Notification_Tab TabBar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_notification_tab );
        try {
            SetHeader("แจ้งเตือน", false, false);
            SetMenu();
            SetBottom();
            SetTabBar();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this, Activity_Page_Notification_Tab.this));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_Notification_Tab.this));
   ...
   public  void  SetTabBar(){
       ...
       Adapter_TabBar_Activity_Page_Notification_Tab TabBar = new Adapter_TabBar_Activity_Page_Notification_Tab( getSupportFragmentManager() );
       ...
       tabfont1.setText("ตนเอง");
       tabfont2.setText("ทีม");
       tabfont3.setText("สาขา");
