...
public class Activity_Page_ClaimFeedBack extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_claimfeedback );

        try {
            SetHeader("FEEDBACK", false, false);
            SetMenu();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimFeedBack.this));
