...
public class ClaimTypeMenu_Tab1_CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public ClaimTypeMenu_Tab1_CustomExpandableListAdapter(Context context, List<String> appid, List<String> Name , List<String> Product, List<String> expire_date, //List<String> expandableListTitle,
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate( R.layout.claim_fragmenttab1_list_item, null );
        }
    ...
    public View getGroupView(final int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService( Context.LAYOUT_INFLATER_SERVICE );
            convertView = layoutInflater.inflate( R.layout.claim_fragmenttab1_list_group, null );
        }
