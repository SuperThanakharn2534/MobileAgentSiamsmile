...
import Adapter.Adapter_PaymentCustomer_FregmentTab_4_Spinner;
...
//        View rootView = inflater.inflate(R.layout.fragmenttab_4, container, false);
//
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return init(inflater.inflate(R.layout.fragmenttab_4, container, false));
    }
    private View init(final View inflate) {
        ...
        b.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.fragmenttab_4_popup);
                ...
                Adapter_PaymentCustomer_FregmentTab_4_Spinner spiner = new Adapter_PaymentCustomer_FregmentTab_4_Spinner(getActivity(),list_01);
                s.setAdapter(spiner);
...
//                        }
        ...
        PaymentCustomerTab4_ExpandableListDataPump opject = new PaymentCustomerTab4_ExpandableListDataPump();
        expandableListDetail = PaymentCustomerTab4_ExpandableListDataPump.getData();
        appid = opject.getAppid();
        Name = opject.getName();
        Product = opject.getProduct();
        expire_date = opject.getexpire_date();
        expandableListAdapter = new PaymentCustomerTab4_CustomExpandableListAdapter(getActivity(),appid,Name,Product,expire_date, expandableListDetail);
