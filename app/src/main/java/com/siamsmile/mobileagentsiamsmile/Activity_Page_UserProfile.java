...
public class Activity_Page_UserProfile extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_userprofile);

        try {
            SetHeader("ข้อมูลส่วนตัว", false, false);
            SetMenu();
            SetBottom();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this, Activity_Page_UserProfile.this));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_UserProfile.this));
