...
public class Activity_Page_ClaimApplicationDetail_Step3 extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_claimapplicationdetail_step3 );

        try {
            SetHeader("รับเรื่องสินไหม_From_4", false, false);
            SetMenu();
            // ButtonNavigation();
            Button();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimApplicationDetail_Step3.this));
...
//        Button next_ = (Button)findViewById(R.id.bt_nextpageclaimstep3_status);
//        next_.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                startActivity(new Intent(getBaseContext(), Activity_Page_ClaimTypeMenu_ClaimStep3_Status.class));
//
//            }
//        });

        Button back_ = (Button)findViewById(R.id.bt_detailstep3_back);
        back_.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_ClaimFrom_Step4.class));
            }
        });
