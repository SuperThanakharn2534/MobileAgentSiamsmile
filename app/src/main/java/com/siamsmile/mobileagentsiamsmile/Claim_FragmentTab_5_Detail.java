...
public class Claim_FragmentTab_5_Detail extends AppCompatActivity {
...
//    DatePickerDialog.OnDateSetListener date;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.claim_fragmenttab_5_detail );
        try {
...
//    }
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Claim_FragmentTab_5_Detail.this));
    ...
    public  void  SetCalendar(){
        ...
        date = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear,
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(Claim_FragmentTab_5_Detail.this,
...
//                                }
        ...
        imgcalendar.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // TODO Auto-generated method stub
                new DatePickerDialog(Claim_FragmentTab_5_Detail.this, date, myCalendar
    ...
    public  void  SetAddFileImage(){
        ...
        textView.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final Dialog dialog = new Dialog( Claim_FragmentTab_5_Detail.this);
                ...
                button2.setOnClickListener( new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText( Claim_FragmentTab_5_Detail.this, "Click Cancel", Toast.LENGTH_SHORT ).show();
                        dialog.cancel();
                    }
                } );
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.menu_add){
            ...
            Intent intentAdd = new Intent(Claim_FragmentTab_5_Detail.this,Activity_Page_ClaimTypeMenu_Status_Tab.class);
