...
public class Activity_Page_ClaimTypeMenu_ClaimStep4_ extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_claimtypemenu_claimstep4_claimauthorize );

        try {
            SetHeader("หนังสื่อมอบอำนาจ", false, false);
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimTypeMenu_ClaimStep4_.this));
    ...
    public  void Button_claim4_(){

        Button next_test = (Button)findViewById(R.id.bt_next_page_);
        next_test.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_ClaimTypeMenu_ClaimStep5_ClaimFile.class));
            }
        });
