...
public class Activity_Page_SearchAgentLocation extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_searchagentlocation);

        try {
            SetHeader("ค้นหาสถานที่ / ตัวแทน ", false, false);
            SetMenu();
            SetBottom();
            //TabView();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this, Activity_Page_SearchAgentLocation.this));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_SearchAgentLocation.this));
...
//    }
    ...
    public void  setUpViewPage(ViewPager viewPage){
       ...
       SectionPageAdapter adapter = new SectionPageAdapter( getSupportFragmentManager() );
        ...
        adapter.addFragment( new Fragment(),"Tab1" );
        adapter.addFragment( new Fragment(),"Tab2" );
        adapter.addFragment( new Fragment(),"Tab3" );
        adapter.addFragment( new Fragment(),"Tab4" );
