...
public class Activity_Page_PayCustomer2_Payment extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_paycustomer_2_pament);

        try {
            SetHeader("บันทึกการส่งเบี้ย_01", false, false);
            SetMenu();
            Button();
            SetBottom();
            setlistdatapayment();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_PayCustomer2_Payment.this));
    ...
    public  void Button(){
        ...
        sent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_PayCustomer2_Payment_Detail.class));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_PayCustomer2_Payment.this));
    ...
    public void  setlistdatapayment(){
        ...
        Adapter_ListData_PaymentCustomer adapter = new Adapter_ListData_PaymentCustomer(Activity_Page_PayCustomer2_Payment.this,
                itemname, itemname2,imgid1);
        ListView list=(ListView)findViewById(R.id.List_DataPaycustomer2);
