...
public class Activity_Page_ClaimTypeMenu_ClaimPolicy_Policy extends AppCompatActivity  implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_claimtypemenu_claimpolicy_policy);
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimTypeMenu_ClaimPolicy_Policy.this));
    ...
    public  void Button(){
        ...
        Button next = (Button)findViewById(R.id.bt_nextpageclaimstep1);
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_ClaimTypeMenu_ClaimStep1_Claim.class));

            }
        });


        Button back = (Button)findViewById(R.id.bt_backtopageclaimtypemenu);
    ...
    public  void  List(){
        ...
        mList.setAdapter(adapterThai);

    }

    private void createListData() {
        mThaiClub.add("เลือกประเภทที่ต้องการค้นหา");
        mThaiClub.add("ชื่อ - นามสกุล");
        mThaiClub.add("เลขที่บัตรประชาชน");
        mThaiClub.add("เลขที่กรมธรรม์");
        mThaiClub.add("เบอร์โทร");
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_ClaimTypeMenu_ClaimPolicy_Policy.this));
