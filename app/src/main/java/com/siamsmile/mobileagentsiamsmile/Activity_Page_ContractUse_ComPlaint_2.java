...
public class Activity_Page_ContractUse_ComPlaint_2 extends AppCompatActivity  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_contractuse_complaint2);

        try {
            SetHeader("แนะนำการให้บริการ", false, false);
            //SetMenu();
            SetBottom();
            setChaptCha();
           // SetTXT_Link();
...
//        gridview.setAdapter(new Adapter_Menu(this, Activity_Page_ContractUse_ComPlaint_2.this));
...
//    }
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_ContractUse_ComPlaint_2.this));
        ...
        btnCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (numberOfCaptchaFalse == 0) {
                    edtTextCaptcha.setText("");
                    Toast.makeText(Activity_Page_ContractUse_ComPlaint_2.this, "All captcha texts match!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.menu_add){
            ...
            Intent intentAdd = new Intent(Activity_Page_ContractUse_ComPlaint_2.this,Activity_Page_ContractUse_ComPlaint.class);
...
//    public void SetTXT_Link(){
//
//        TextView txt_link=(TextView)findViewById( R.id.Click_Txt_Link );
//           txt_link.setOnClickListener( new View.OnClickListener() {
//               @Override
//               public void onClick(View view) {
//                   final Dialog dialog = new Dialog(Activity_Page_ContractUse_ComPlaint_2.this);
//
//                   dialog.requestWindowFeature( Window.FEATURE_NO_TITLE);
//                   dialog.setContentView(R.layout.activity_page_contractuse_2_popup);
