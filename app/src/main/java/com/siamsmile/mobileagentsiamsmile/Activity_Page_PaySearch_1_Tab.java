...
import Adapter.Adapter_TabBar_PaySearch_1;
...
public class Activity_Page_PaySearch_1_Tab extends AppCompatActivity implements AdapterView.OnItemClickListener  {
   ...
   // private Adapter_TabBar_Payment TabBar;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_paysearch_1_tab );


        try {
            SetHeader("ชำระเบี้ยประกัน", false, false);
            SetMenu();
            SetBottom();
            SetTab_PaySearch_1();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_PaySearch_1_Tab.this));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_PaySearch_1_Tab.this));
    ...
    public void SetTab_PaySearch_1(){

        Adapter_TabBar_PaySearch_1 TabBar_4 = new Adapter_TabBar_PaySearch_1( getSupportFragmentManager() );
        mViewPager_4 = (ViewPager)findViewById(R.id.container_4);
        mViewPager_4.setAdapter(TabBar_4);

        tabLayout_4 = (TabLayout)findViewById(R.id.tabs_4);
        tabLayout_4.setupWithViewPager(mViewPager_4);
        ...
        tabfont1.setText("เลือกกรมธรรม์");
        tabfont2.setText("ช่องทางการชำระเบี้ย");


        tabLayout_4.getTabAt(0).setCustomView(tabfont1);
        tabLayout_4.getTabAt(1).setCustomView(tabfont2);
