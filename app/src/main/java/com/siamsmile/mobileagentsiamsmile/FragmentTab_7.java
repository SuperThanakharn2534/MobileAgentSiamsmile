...
import Adapter.Adapter_PaymentCustomer_FregmentTab_7_Spinner;
...
//        View rootView = inflater.inflate(R.layout.fragmenttab_7, container, false);
//
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return init(inflater.inflate(R.layout.fragmenttab_7, container, false));
    }
    private View init(final View inflate) {
        ...
        b.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.fragmenttab_7_popup);
                ...
                Adapter_PaymentCustomer_FregmentTab_7_Spinner spiner = new Adapter_PaymentCustomer_FregmentTab_7_Spinner(getActivity(),list_01);
                s.setAdapter(spiner);
...
//                        }
        ...
        PaymentCustomerTab7_ExpandableListDataPump opject = new PaymentCustomerTab7_ExpandableListDataPump();
        expandableListDetail = PaymentCustomerTab7_ExpandableListDataPump.getData();
        appid = opject.getAppid();
        Name = opject.getName();
        Product = opject.getProduct();
        expire_date = opject.getexpire_date();
        expandableListAdapter = new PaymentCustomerTab7_CustomExpandableListAdapter(getActivity(),appid,Name,Product,expire_date, expandableListDetail);
