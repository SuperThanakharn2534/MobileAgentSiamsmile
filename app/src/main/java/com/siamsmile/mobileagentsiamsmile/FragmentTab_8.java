...
import Adapter.Adapter_PaymentCustomer_FregmentTab_8_Spinner;

/**
 * Created by aligndev on 02-Nov-17.
 */

public class FragmentTab_8 extends Fragment  {
...
//        View rootView = inflater.inflate(R.layout.fragmenttab_8, container, false);
//
...
public View onCreateView(LayoutInflater inflater, ViewGroup container,
                         Bundle savedInstanceState) {
    return init(inflater.inflate(R.layout.fragmenttab_8, container, false));
}
    private View init(final View inflate) {
        ...
        b.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.fragmenttab_8_popup);
                ...
                Adapter_PaymentCustomer_FregmentTab_8_Spinner spiner = new Adapter_PaymentCustomer_FregmentTab_8_Spinner(getActivity(),list_01);
                s.setAdapter(spiner);
...
//                        }
        ...
        PaymentCustomerTab8_ExpandableListDataPump opject = new PaymentCustomerTab8_ExpandableListDataPump();
        expandableListDetail = PaymentCustomerTab8_ExpandableListDataPump.getData();
        appid = opject.getAppid();
        Name = opject.getName();
        Product = opject.getProduct();
        expire_date = opject.getexpire_date();

        expandableListAdapter = new PaymentCustomerTab8_CustomExpandableListAdapter(getActivity(),appid,Name,Product,expire_date, expandableListDetail);
