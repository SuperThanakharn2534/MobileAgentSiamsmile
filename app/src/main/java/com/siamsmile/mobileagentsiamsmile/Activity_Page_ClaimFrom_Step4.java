...
public class Activity_Page_ClaimFrom_Step4 extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_claimfrom_step4 );
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimFrom_Step4.this));
...
//        });
        ...
        Button back_ = (Button)findViewById(R.id.bt_claimpayment_04);
        back_.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_ClaimFile_Step5.class));
            }
        });
