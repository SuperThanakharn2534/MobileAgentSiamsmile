...
public class Activity_Page_ClaimStatus extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_claimstatus );


        try {
            SetHeader("สถานะการเคลม", false, false);
            SetMenu();
            Button();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimStatus.this));
