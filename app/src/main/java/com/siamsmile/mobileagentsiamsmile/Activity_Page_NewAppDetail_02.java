...
public class Activity_Page_NewAppDetail_02 extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_newappdetail_02);

        try {
            SetHeader("บันทึก NewAppDetail_02", false, false);
            SetMenu();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this, Activity_Page_NewAppDetail_02.this));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_NewAppDetail_02.this));
