...
public class Activity_Page_ClaimFile_Step5 extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_claimfile_step5 );

        try {
            SetHeader("รับเรื่องสินไหม_File_5", false, false);
            SetMenu();
            // ButtonNavigation();
            Button();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimFile_Step5.this));
...
//        });
        ...
        Button back_ = (Button)findViewById(R.id.txt_nextclaimstep6);
        back_.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_ClaimSign_Step6.class));
            }
        });
