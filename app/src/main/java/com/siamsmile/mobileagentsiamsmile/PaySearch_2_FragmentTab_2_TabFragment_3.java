...
public class PaySearch_2_FragmentTab_2_TabFragment_3 extends Fragment  {

    View rootView;



    public PaySearch_2_FragmentTab_2_TabFragment_3() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate( R.layout.paysearch_2_fragmenttab_2_tabfragment_3, container, false );
...
//                startActivity(new Intent(getActivity(),PaySearch_2_FragmentTab_2_TabFragment_3_PopUp.class));
//            }
//        } );
        ...
        button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.paysearch_2_fragmenttab_2_tabfragment_3_popup);
