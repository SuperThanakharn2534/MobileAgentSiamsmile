...
public class Activity_Page_ContractUse_ComPlaint_3 extends AppCompatActivity  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_contractuse_complaint3);

        try {
            SetHeader("ชมเชย", false, false);
            //SetMenu();
            SetBottom();
            setChaptCha();
...
//        gridview.setAdapter(new Adapter_Menu(this, Activity_Page_ContractUse_ComPlaint_3.this));
...
//    }
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_ContractUse_ComPlaint_3.this));
        ...
        btnCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (numberOfCaptchaFalse == 0) {
                    edtTextCaptcha.setText("");
                    Toast.makeText(Activity_Page_ContractUse_ComPlaint_3.this, "All captcha texts match!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.menu_add){
            ...
            Intent intentAdd2 = new Intent(Activity_Page_ContractUse_ComPlaint_3.this,Activity_Page_ContractUse_ComPlaint.class);
