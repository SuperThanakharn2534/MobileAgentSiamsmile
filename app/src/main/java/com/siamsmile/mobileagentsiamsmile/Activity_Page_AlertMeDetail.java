...
public class Activity_Page_AlertMeDetail extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_alertmedetail);


        try {
            SetHeader(" Alert Me Detail_2", false, false);
            SetMenu();
            SetBottom();
            Button();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this, Activity_Page_AlertMeDetail.this));
    ...
    public  void  Button(){
        ...
        Button sent = (Button) findViewById(R.id.bt_backtopagealertmelist);
        sent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_AlertMe_List.class));
            }
        });
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_AlertMeDetail.this));
