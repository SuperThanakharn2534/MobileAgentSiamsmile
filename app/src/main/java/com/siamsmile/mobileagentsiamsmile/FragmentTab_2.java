...
import Adapter.Adapter_PaymentCustomer_FregmentTab_2_Spinner;
...
//        View rootView = inflater.inflate(R.layout.fragmenttab_2, container, false);
//
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return init(inflater.inflate(R.layout.fragmenttab_2, container, false));
    }
    private View init(final View inflate) {
        ...
        b.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.fragmenttab_2_popup);
                ...
                Adapter_PaymentCustomer_FregmentTab_2_Spinner spiner = new Adapter_PaymentCustomer_FregmentTab_2_Spinner(getActivity(),list_01);
                s.setAdapter(spiner);
        ...
        PaymentCustomerTab2_ExpandableListDataPump opject = new PaymentCustomerTab2_ExpandableListDataPump();
        expandableListDetail = PaymentCustomerTab2_ExpandableListDataPump.getData();
        appid = opject.getAppid();
        Name = opject.getName();
        Product = opject.getProduct();
        expire_date = opject.getexpire_date();
        expandableListTitle = new ArrayList<String>(expandableListDetail.keySet());
        expandableListAdapter = new PaymentCustomerTab2_CustomExpandableListAdapter(getActivity(),appid,Name,Product,expire_date, expandableListDetail);
