...
public class Activity_Page_ProductMediaDetail extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_page_productmediadetail);

        try {
            SetHeader("Product Media_2", false, false);
            SetMenu();
            Button();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this, Activity_Page_ProductMediaDetail.this));
    ...
    public  void  Button(){
        ...
        Button sent = (Button) findViewById(R.id.bt_pageproductmedia);
        sent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_ProductMedia.class));
            }
        });
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_ProductMediaDetail.this));
