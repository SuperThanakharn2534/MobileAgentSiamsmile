...
import Adapter.Adapter_Notification_1_FregmentTab_1_Spinner;

/**
 * Created by aligndev on 02-Nov-17.
 */

public class Activity_Page_Notification_Tab_FragmentTab_1 extends Fragment implements View.OnClickListener {
    ...
    public Activity_Page_Notification_Tab_FragmentTab_1() {
        // Required empty public constructor
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return init( inflater.inflate( R.layout.activity_page_notification_tab_fragmenttab_1, container, false ) );
    }
    private View init(final View inflate) {
        ...
        b.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.notification_tab_1_popup);
                ...
                Adapter_Notification_1_FregmentTab_1_Spinner spiner = new Adapter_Notification_1_FregmentTab_1_Spinner(getActivity(),list_01);
                s.setAdapter(spiner);
        ...
        Activity_Page_Notification_FragmentTab1_ExpandableListDataPump opject  = new Activity_Page_Notification_FragmentTab1_ExpandableListDataPump();
        expandableListDetail = Activity_Page_Notification_FragmentTab1_ExpandableListDataPump.getData();
        ...
        expandableListAdapter = new Activity_Page_Notification_Fragmenttab1_CustomExpandableListAdapter(getActivity(),appid,Name,Product,expire_Date,Alerttype,Name2,Image, expandableListDetail);
