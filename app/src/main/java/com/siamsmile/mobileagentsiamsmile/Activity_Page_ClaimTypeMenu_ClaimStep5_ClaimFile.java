...
/**
 * Created by aligndev on 18-Oct-17.
 */

public class Activity_Page_ClaimTypeMenu_ClaimStep5_ClaimFile extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_claimtypemenu_claimstep5_claimfile );

        try {
            SetHeader("อัพโหลดไฟล์", false, false);
            SetMenu();
            //ButtonNavigation();
            Button_claim5_();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_ClaimTypeMenu_ClaimStep5_ClaimFile.this));
    ...
    public  void Button_claim5_(){

        Button next_test = (Button)findViewById(R.id.txt_nextclaimstep6);
        next_test.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getBaseContext(), Activity_Page_ClaimTypeMenu_ClaimStep6_ClaimSign.class));
            }
        });
