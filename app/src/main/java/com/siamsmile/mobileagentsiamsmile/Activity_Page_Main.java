...
public class Activity_Page_Main extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            SetHeader("หน้าหลัก", false, false);
            SetMenu();
            SetBottom();
            WebPage();
        }catch (Exception e){}
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_Main.this));
...
//        bottomNavigationView.setItemIconTintList( ContextCompat.getColorStateList(this, R.color.colorPrimary));
//        bottomNavigationView.setItemTextColor(ContextCompat.getColorStateList(this,R.color.colorPrimary));
//
//
...
//    }
    ...
    public void  WebPage(){
        //  WebView
        WebView WebViw = (WebView) this.findViewById(R.id.web_page);
        WebViw.getSettings().setJavaScriptEnabled(true);
        //WebViw.getSettings().setJavaScriptCanOpenWindowsAutomatically(true);
        WebViw.loadUrl("http://www.siamsmilecard.com/default.aspx");
        WebViw.getSettings().setJavaScriptEnabled(true);
        WebViw.setWebViewClient(new WebViewClient());
       // WebViw.loadUrl("http://www.daydev.com/movies/drama.html");
    ...
    public void selectItem2(int position) {
       ...
       public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_Main.this));
