...
public class PaySearch_1_FragmentTab_2_TabFragment_1 extends Fragment  {
    ...
    public PaySearch_1_FragmentTab_2_TabFragment_1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate( R.layout.paysearch_1_fragmenttab_2_tabfragment_1, container, false );
...
//        } );
        ...
        button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.paysearch_1_fragmenttab_2_tabfragment_1_popup);
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Toast.makeText(getActivity(),"Click ตกลง",Toast.LENGTH_SHORT).show();
                            dialog.cancel();
                    }
                });
                ...
                button2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(getActivity(),"Click ยกเลิก",Toast.LENGTH_SHORT).show();
                        dialog.cancel();
                    }
                });
