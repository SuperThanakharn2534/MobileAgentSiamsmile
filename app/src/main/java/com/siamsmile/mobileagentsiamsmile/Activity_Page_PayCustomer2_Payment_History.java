...
public class Activity_Page_PayCustomer2_Payment_History extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_paycustomer2_payment_history );

        try {
            SetHeader("บันทึกการส่งเบี้ย_03", false, false);
            SetMenu();
            Button();
            SetBottom();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_PayCustomer2_Payment_History.this));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_PayCustomer2_Payment_History.this));
