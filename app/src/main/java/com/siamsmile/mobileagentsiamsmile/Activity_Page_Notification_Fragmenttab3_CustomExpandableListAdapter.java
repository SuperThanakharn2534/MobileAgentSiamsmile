...
public class Activity_Page_Notification_Fragmenttab3_CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public Activity_Page_Notification_Fragmenttab3_CustomExpandableListAdapter(Context context, List<String> appid,List<String> Name,List<String> Product,List<String>expire_Date,List<String> Alerttype,List<String> Name2,List<String> Image,  //List<String> expandableListTitle,
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate( R.layout.notification_tab3_list_item, null );
        }
    ...
    public View getGroupView(final int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService( Context.LAYOUT_INFLATER_SERVICE );
            convertView = layoutInflater.inflate( R.layout.notification_tab3_list_group, null );
        }
        //code set Text Data
