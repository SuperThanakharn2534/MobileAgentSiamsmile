...
public class PaySearch_1_FragmentTab_2_TabFragment_3 extends Fragment  {
    ...
    public PaySearch_1_FragmentTab_2_TabFragment_3() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate( R.layout.paysearch_1_fragmenttab_2_tabfragment_3, container, false );
...
//                startActivity(new Intent(getActivity(),PaySearch_1_FragmentTab_2_TabFragment_3_PopUp.class));
//            }
//        } );
        button.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.paysearch_1_fragmenttab_2_tabfragment_3_popup);
