...
public class Activity_Page_PaymentReport_Tab extends AppCompatActivity implements AdapterView.OnItemClickListener  {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_page_paymentreport_tab );


        try {
            SetHeader("รายงานจัดเก็บ", false, false);
            SetMenu();
            SetBottom();
            SetTab();
...
//        Menugridview.setAdapter(Adapter);
        ...
        gridview.setAdapter(new Adapter_Menu(this,Activity_Page_PaymentReport_Tab.this));
    ...
    public void  SetBottom(){
        ...
        gridview.setAdapter(new Adapter_Botton(this,Activity_Page_PaymentReport_Tab.this));
    ...
    public void SetTab(){
         ...
         TabBar =new Adapter_TabBar_PaymentReport( getSupportFragmentManager() );
